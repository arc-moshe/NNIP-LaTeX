...
\usepackage{fancyhdr} % Special Headers & Footers 
 	\pagestyle{fancy} 
 	\fancyhead[C]{\LARGE{\textcolor{arcindigo}{\textbf{Demographic Profile: Fulton County}}}}  
 	\fancyfoot[R]{\href{http://www.atlantaregional.org}{\includegraphics[height = .25in]{ARCMarkGold.pdf}}} % Put logo in footer and have it be a clickable link
 	\fancyfoot[C]{} 

\usepackage[hidelinks]{hyperref} % Allows you to make links, such as outside URLs. The hidelinks option suppresses any boxes.
\usepackage{bookmark} % Allows for bookmarks in the PDF

\usepackage{graphicx}	% Enables insertion of outside images into doc 
...
\section*{\textcolor{arcindigo}{Race and Ethnicity}}
\addcontentsline{toc}{section}{Race and Ethnicity} % Optional (if you want a bookmark)
...
\section*{\textcolor{arcindigo}{Educational Attainment}}
\addcontentsline{toc}{section}{Educational Attainment} % Optional (if you want a bookmark)
...
\section*{\textcolor{arcindigo}{Housing Cost Burdened Households}}
\addcontentsline{toc}{section}{Housing Cost Burdened Households} % Optional (if you want a bookmark)
